          ...
          <div className='flex'>
            ...
            <div className='h=[100%] w-[48%] flex flex-col justify-between items-center'>
              <div className='flex flex-col justify-between w-[100%] h-[80%] px-4'>
                <input style={{ width: '100%', height: "3rem", border: "1px dashed lightgray" }} />
                <input style={{ width: '100%', height: "3rem", border: "1px dashed lightgray" }} />
                <input style={{ width: '100%', height: "3rem", border: "1px dashed lightgray" }} />
                <textarea style={{ width: '100%', height: "5rem", border: "1px dashed lightgray" }} />
              </div>
              <div className='text-xs text-white text-gray-700 border border-2 border-cyan-700 font-bold w-44 px-8 py-4 mt-[5%] text-center bg-cyan-700 hover:bg-transparent hover:text-cyan-700'>
                SEND
              </div>
            </div>
          </div>
