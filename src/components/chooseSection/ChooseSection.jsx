          ...
          <div className='w-[41%] h-[100%]  flex flex-col justify-between'>
            <div className='h-[49%] w-[98%]  border border-gray-300 rounded-md flex p-4'>
              ...
              <div className='pl-3'>
                ...
                <div id="choose-text" className='pt-2 text-sm text-gray-400 font-normal'>You are our priority. We Provide our services 24/7. If you
            ...
            <div className='h-[49%] w-[98%]  border border-gray-300 rounded-md flex p-4'>
              ...
              <div className='pl-3'>
                ...
                <div id="choose-text" className='pt-2 text-sm text-gray-400 font-normal'>You are our priority. If you are not comfortable with
